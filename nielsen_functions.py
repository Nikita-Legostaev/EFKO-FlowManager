...
def melt_polars(df, id_cols: list[str]):
    ...
    return (
        df.unpivot(index=id_cols, on=date_cols, variable_name="ATTRIBUTE", value_name="VALUE")
        .with_columns(
            pl.col("ATTRIBUTE")
...
def optimize_for_size(df):
    import polars as pl
    cat_cols = [
        "MARKET", "FACT", "Long Description", "MANUFACTURER", "BRAND",
    ...
    if fmt == "csv":
        ...
        if num_parts > 1:
            for i in range(num_parts):
                ...
                chunk.write_excel(output_dir / f"{name}_part{i + 1}.xlsx", worksheet="Data")
...
def process_nielsen(
    ...
    if category == "Масло":
        ...
        product_base_map = {
            "ALMOND": "прочие", "ALMOND & SUNFLOWER": "микс", "AMARANTH": "прочие",
            "AMARANTH & LINSEED": "прочие", "APRICOT KERNEL": "прочие", "ARGAN": "прочие",
            "AVOCADO": "прочие", "AVOCADO & COCONUT": "прочие", "AVOCADO & OLIVE": "прочие",
            "AVOCADO & SUNFLOWER": "микс", "BLACK CUMIN SEED": "прочие", "BLACK SESAME": "прочие",
            "CAMELINA (RYZHIK)": "прочие", "CANOLA SEED": "прочие", "CEDAR NUT": "прочие",
            "CEDAR NUT & LINSEED": "прочие", "CEDAR NUT & LINSEED & SESAME & SUNFLOWER": "прочие",
            "CEDAR NUT & PEANUT & WALNUT": "прочие", "CEDAR NUT & SUNFLOWER": "микс",
            "CEREAL & FRUIT": "прочие", "CHIA SEED": "прочие", "CHIA SEED & SUNFLOWER": "прочие",
            "COCOA": "прочие", "COCONUT": "прочие", "COCONUT & PALM": "прочие",
            "COLESEED": "прочие", "CORN": "кукурузное", "CORN & SUNFLOWER": "микс",
            "CORN GERM": "кукурузное", "CORN SEEDS & GRAPE SEEDS & RAPE SEEDS & RICE BRAN & SESAME": "прочие",
            "COTTON": "прочие", "CUMIN SEED": "прочие", "GRAPE SEEDS": "прочие",
            "GRAPE SEEDS & SUNFLOWER": "микс", "HAZELNUT": "прочие", "HEMP": "прочие",
            "HEMP & LINSEED": "прочие", "HEMP & SUNFLOWER": "прочие", "LINSEED": "прочие",
            "LINSEED & MUSTARD & SUNFLOWER": "прочие", "LINSEED & OLIVE": "прочие",
            "LINSEED & PUMPKIN SEEDS": "прочие", "LINSEED & SESAME": "прочие",
            "LINSEED & SUNFLOWER": "микс", "LINSEED & WALNUT": "прочие",
            "MACADAMIA NUT": "прочие", "MIX OIL": "прочие", "MUSTARD": "прочие",
            "MUSTARD & SUNFLOWER": "прочие", "MUSTARD & SUNFLOWER & WALNUT": "прочие",
            "NUT": "прочие", "OLIVE": "оливковое", "OLIVE & PUMPKIN": "прочие",
            "OLIVE & RAPE SEED": "прочие", "OLIVE & SESAME": "прочие",
            "OLIVE OIL & SUNFLOWER": "микс", "PALM": "прочие", "PEANUT": "прочие",
            "PISTACHIO": "прочие", "POPPY SEED": "прочие", "PUMPKIN SEEDS": "прочие",
            "RAPE SEED & SUNFLOWER": "микс", "RAPE SEEDS": "прочие",
            "RAPE SEEDS & SAFFLOWER & SUNFLOWER": "прочие", "RICE": "прочие",
            "ROSEHIP": "прочие", "RUCCOLA SEED": "прочие", "SAFFLOWER": "прочие",
            "SEA BUCKTHORN & SUNFLOWER": "микс", "SEABERRY / SEA BUCKTHORN": "прочие",
            "SESAME": "прочие", "SOYA": "прочие", "SUNFLOWER": "подсолнечное",
            "SUNFLOWER & SESAME": "микс", "SUNFLOWER & SOYA": "микс",
            "SUNFLOWER & WALNUT": "микс", "THISTLE SEEDS (RASTOROPSHA)": "прочие",
            "TRIGONELLA": "прочие", "WALNUT (GRETSKIY OREKH)": "прочие",
            "WATERMELON SEEDS": "прочие", "WHEAT GERM": "прочие",
            "WHITE SESAME": "прочие",
        }
    else:
        refine_map = {}
        product_base_map = {}
        log(f"Для категории '{category}' маппинги не заданы — используются значения по умолчанию.")
    ...
    data["SKU_long_filtered"] = (
        ...
        .with_columns([
            pl.col("IF REFINED")
            .cast(pl.Utf8).str.strip_chars().str.to_uppercase()
