...
class SplashScreen:
    def __init__(self):
        ...
        self._bx2 = self.W - 50
        self._by2 = 183
        c.create_rectangle(self._bx1, self._by1,
                           self._bx2, self._by2,
                           fill="#2aaa52", outline="")
